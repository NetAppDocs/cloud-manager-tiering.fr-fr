...
* Pour vous abonner à Azure Marketplace, https://azuremarketplace.microsoft.com/en-us/marketplace/apps/netapp.cloud-manager?tab=Overview["Accédez à l'offre Cloud Manager Marketplace"^], Cliquez sur *s'abonner*, puis suivez les invites.
