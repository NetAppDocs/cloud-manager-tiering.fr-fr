...
* Pour vous abonner à GCP Marketplace, https://console.cloud.google.com/marketplace/details/netapp-cloudmanager/cloud-manager?supportedpurview=project&rif_reserved["Accédez à l'offre Cloud Manager Marketplace"^], Cliquez sur *s'abonner*, puis suivez les invites.
